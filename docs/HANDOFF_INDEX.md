...
| 2026-07-25 | `H008` | Standalone engineering portfolio report template | Portfolio report template | `feature/portfolio-report-template` | Open in PR #9; preview artifact deferred | [`H008-portfolio-report-template.md`](handoffs/H008-portfolio-report-template.md) |
